...
// Recebe as novas props para o menu mobile: isOpen e setIsOpen
export default function Sidebar({ user, onLogout, theme, onThemeSwitch, isOpen, setIsOpen }) {
  ...
  return (
    <>
      {/* Overlay para o fundo escuro no mobile */}
      <div 
      ...
      >
        <div className="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          {/* Rodapé com Infos do Usuário e Logout */}
          <div className="p-4 border-t border-gray-200 dark:border-gray-700">
            ...
            <button onClick={onLogout} className="w-full flex items-center justify-center gap-2 mt-2 px-4 py-2 rounded-lg text-sm text-red-500 hover:bg-red-500 hover:text-white dark:hover:bg-red-600 font-medium transition-colors">
              <LogoutIcon /> Sair
            </button>
          </div>
        </div>
