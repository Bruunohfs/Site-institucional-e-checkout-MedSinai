      ...
      >
        <div className="flex flex-col h-full bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700">
          ...
          <nav className="flex-grow p-4 space-y-2">
            ...
            <NavLink to="/parceiros/financeiro" onClick={handleLinkClick} className={({ isActive }) => `${linkStyle} ${isActive ? activeLinkStyle : inactiveLinkStyle}`}>
              <FinanceIcon /> Meu Financeiro
            </NavLink>
