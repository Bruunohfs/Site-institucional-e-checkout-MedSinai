    ...
    <>
      ...
      <div className="container">
        ...
        <section className="hero">
          <div>
            <div className="kicker">Para Comércio e Varejo</div>
            <h1>Mais saúde para seu time — Comércio e Varejo</h1>
            <p>
              Cuide da equipe com telemedicina 24h e clube de vantagens que cabe no
              bolso.
            </p>
            ...
            <div className="cta">
              <a
                ...
                href="https://wa.me/5516997481801?text=Ol%C3%A1%20Lucas!%20Quero%20uma%20proposta%20do%20MedSinai%20para%20Mais saúde para seu time - Comércio e Varejo."
                target="_blank"
        ...
        <section className="section">
          ...
          <div className="grid">
            <div className="card">
              <h3>Mais vendas com equipe saudável</h3>
              <p>Bem‑estar impacta atendimento e resultados no PDV.</p>
            </div>
            <div className="card">
              <h3>Atrair e reter talentos</h3>
              <p>Ofereça um benefício valorizado no varejo, sem coparticipação.</p>
            </div>
            <div className="card">
              <h3>Ativação rápida</h3>
              <p>Sem burocracia: adesão e uso no mesmo dia.</p>
            </div>
          </div>
        </section>
        <section className="section">
...
export default LandingPageComercio;
