...
// Ícones (pode copiar os ícones do outro sidebar se quiser)
...
// --- 1. RECEBER AS PROPS `isOpen` e `setIsOpen` ---
export default function AdminSidebar({ user, onLogout, theme, onThemeSwitch, isOpen, setIsOpen }) {
  ...
  return (
    <>
      {/* --- 2. ADICIONAR O FUNDO ESCURO (OVERLAY) PARA MOBILE --- */}
      <div 
      ...
      {/* --- 3. APLICAR CLASSES RESPONSIVAS AO CONTAINER PRINCIPAL DO SIDEBAR --- */}
      <div 
      ...
      >
        ...
        <nav className="flex-grow p-4 space-y-2">
          {/* --- 4. ADICIONAR `onClick={handleLinkClick}` AOS LINKS --- */}
